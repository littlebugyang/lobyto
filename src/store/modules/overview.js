export default {
  ...
  actions: {
    ...
    toggleEditTaskModal ({ commit, state }, editTaskModal) {
      const newEditTaskModal = Object.assign(
        Object.assign({}, state.editTaskModal), editTaskModal)
      commit('update', { prop: 'editTaskModal', data: newEditTaskModal })
    },
    toggleConfirmModal ({ commit, state }, confirmModal) {
      const newConfirmModal = Object.assign(
        Object.assign({}, state.confirmModal), confirmModal)
